...
1. [The first transition](#the-first-transition)
2. [The digital age](#the-digital-age)
3. [Loss of humanity through transitions](#loss-of-humanity-through-transitions)
4. [Chasing perfection](#chasing-perfection)
...
<figure>
  <blockquote>
    <p>
      Knowledge of the quality of a typeface is of the greatest importance for
      the functional, aesthetic and psychological effect.
    </p>
    <footer>
